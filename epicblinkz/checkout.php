...
if (isset($_POST['order_btn'])) {
   ...
   try {
       ...
       $detail_query->execute([$name, $number, $email, $method, $flat, $street, $city, $province, $country, $pin_code, $total_product, $price_total]);
...
<section class="checkout-form">
   ...
   <div class="display-order">
    ...
    try {
        // Buat koneksi PDO
        $conn = new PDO("pgsql:host=localhost;dbname=db_epicblinkz", "postgres", "postgres");
